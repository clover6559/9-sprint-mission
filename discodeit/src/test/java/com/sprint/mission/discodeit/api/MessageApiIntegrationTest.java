...
public class MessageApiIntegrationTest {
    ...
    void createMessage() throws Exception {
        ...
        MockMultipartFile filePart =
                new MockMultipartFile("attachments", "test.txt", MediaType.TEXT_PLAIN_VALUE, "hello world".getBytes());
    ...
    void deleteMessage() throws Exception {
        ...
        mockMvc.perform(delete("/api/messages/{messageId}", message.getId())).andExpect(status().isNoContent());
    }
}
