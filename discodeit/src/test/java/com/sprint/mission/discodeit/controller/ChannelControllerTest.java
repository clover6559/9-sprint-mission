...
import com.sprint.mission.discodeit.api.controller.ChannelController;
...
class ChannelControllerTest {
  ...
  void createPublic_success() throws Exception {
    ...
    ChannelDto responseDto = new ChannelDto(UUID.randomUUID(), ChannelType.PUBLIC, "General",
        "공개 채널 설명", Collections.emptyList(), Instant.now());
  ...
  void findAll_success() throws Exception {
    ...
    ChannelDto channel1 = new ChannelDto(UUID.randomUUID(), ChannelType.PUBLIC, "Channel 1",
        "Desc 1", Collections.emptyList(), Instant.now());
