...
public interface ChannelApi {
  ...
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "201", description = "채널이 성공적으로 생성됨",
          content = @Content(schema = @Schema(implementation = Channel.class))
      ),
      @ApiResponse(
          responseCode = "400", description = "같은 채널이 이미 존재함",
  ...
  @ApiResponses(value = {
      ...
      @ApiResponse(
          responseCode = "400", description = "같은 name를 사용하는 Channel을 이미 존재함",
  ...
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "200", description = "사용자가 참여중인 채널 목록 조회 성공",
