...
//
//        // 수정
//        String updateChannel = channelService.update(channel.getId(), "공지사항", null);
...
//
//        channelService.create(Channel.ChannelType.PUBLIC, "공지", "공지합니다", user1);
//        channelService.create(Channel.ChannelType.PRIVATE, "사담", "사담합시다", user1);
//
//        // 테스트
